...
# Parameters
INIT_SNAPSHOT_NUM=3946  # Starting snapshot number
DT_EXPECTED=0.006    # Expected time separation between snapshots
RAW_DIR="./0_RAW/res_6*"
LA2_FILE="la2naca_wing0.f*"
...
find -L $RAW_DIR -type f -name $LA2_FILE | while read -r filepath; do
