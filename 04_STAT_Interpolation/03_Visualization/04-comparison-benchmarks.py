...
for case_name in data.keys():
  ...
  fig,axs = plot_integral_quantities(data[case_name]['data_SS'],fig,axs,
                                    x_start,x_end,
                                    var,var_Name,style_dict,interval=2)
...
fig.savefig(f'Figs_{Rec}k/02-BL-DEVELP/cf_cp_BothSides.jpg',
              **figkw
              )
...
fig.savefig(f'Figs_{Rec}k/02-BL-DEVELP/BL_{il+1}VARS.jpg',
                **figkw
                )
